...
describe('SideBar', () => {
  ...
  describe('navigation links', () => {
    ...
    it('renders jobs link', () => {
      ...
      const jobsLink = jobsLinks.find((link) => link.getAttribute('href') === '/jobs')
    ...
    it('renders calendar link', () => {
      ...
      const calendarLink = links.find((link) => link.getAttribute('href') === '/calendar')
    ...
    it('renders contacts link', () => {
      render(<SideBar />)
      const links = screen.getAllByRole('link')
      const contactsLink = links.find((link) => link.getAttribute('href') === '/contacts')
  ...
  describe('role-based access', () => {
    it('shows create job link for Owner users', () => {
      ...
      render(<SideBar />)
      const links = screen.getAllByRole('link')
      const newJobLink = links.find((link) => link.getAttribute('href') === '/jobs/new')
