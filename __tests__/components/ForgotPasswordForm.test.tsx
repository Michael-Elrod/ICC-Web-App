...
describe('ForgotPasswordForm', () => {
  ...
  it('submits email and shows success message', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/If an account exists with this email address/)).toBeInTheDocument()
    })
  ...
  it('does not reveal whether email exists', async () => {
    ...
    await waitFor(() => {
      const successText = screen.getByText(/If an account exists with this email address/)
